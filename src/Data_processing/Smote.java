...
public class Smote implements Pre_process_interface {
    ...
    public Instances applySmote(Instances data) {
        ...
        for (int i = 0; i < data.numInstances(); i++) {
            ...
            String classValue = instance.stringValue(11);
        ...
        for (String classValue : classInstances.keySet()) {
            ...
            if (classInstances.get(classValue).size() >= sampling_strategy.get(classValue)) continue;
            ArrayList<Instance> currentInstances = classInstances.get(classValue);
            int numSynthetic = sampling_strategy.get(classValue) - classInstances.get(classValue).size();
